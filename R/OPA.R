...
#' @examples 
#' \donttest{
#' X = random.landscape(units = 100,n=50,range.pts = 10,range.radii = 1,radius.mean=1,radius.sd=1) 
...
#' nsim=1e3, simulate=expression(random.landscape(units=100,n=50,radius.mean=1,radius.sd=1)))
#' 
