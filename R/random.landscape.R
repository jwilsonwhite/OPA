...
#'
#'@param res the resolution of the landscape lattice. This is width (in number of lattice points) of the square study area, or diameter of the circular study area. A value ≥ 100 is recommended to approximate a continuous non-lattice landscape
